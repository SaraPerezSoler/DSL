...
@after {
	...
	(
		...
		{
			$current = $this_JavaDoc_16.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Contains_17.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
@after {
	...
	(
		...
		(
		    ...
		    |
		(
			enumLiteral_2='UPPER_CAMEL_CASE'
			{
		    ...
		    |
		(
			enumLiteral_3='LOWER_CAMEL_CASE'
			{
		    ...
		    |
		(
			enumLiteral_4='START_UPPER_CASE'
			{
