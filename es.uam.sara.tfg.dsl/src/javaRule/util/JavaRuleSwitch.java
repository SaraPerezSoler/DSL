...
public class JavaRuleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JavaRulePackage.HAVE_CONSTANT: {
				HaveConstant haveConstant = (HaveConstant)theEObject;
				T result = caseHaveConstant(haveConstant);
				if (result == null) result = caseMethod(haveConstant);
				if (result == null) result = caseSatisfy(haveConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaRulePackage.VARIABLE: {
				...
				if (result == null) result = caseMethod(variable);
				if (result == null) result = caseSatisfy(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JavaRulePackage.JAVA_DOC: {
				...
				if (result == null) result = casePackage(javaDoc);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Have Constant</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Have Constant</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHaveConstant(HaveConstant object) {
		return null;
	}
