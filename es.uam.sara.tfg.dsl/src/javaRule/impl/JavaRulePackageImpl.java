...
public class JavaRulePackageImpl extends EPackageImpl implements JavaRulePackage {
	 ...
	 * @generated
	 */
	private EClass haveConstantEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getTesting_No() {
	 ...
	 * @generated
	 */
	public EAttribute getTesting_Quantifier() {
	 ...
	 * @generated
	 */
	public EReference getTesting_Element() {
	 ...
	 * @generated
	 */
	public EReference getTesting_Satisfy() {
	 ...
	 * @generated
	 */
	public EAttribute getIsInheritor_MaxLevel() {
		return (EAttribute)isInheritorEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIsExtended_IsExtends() {
		return (EAttribute)isExtendedEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getHaveConstant() {
		return haveConstantEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVariable_Position() {
	 ...
	 * @generated
	 */
	public EAttribute getVariable_Initialize() {
	...
	public void createPackageContents() {
		...
		createEReference(ruleEClass, RULE__ON);

		testingEClass = createEClass(TESTING);
		createEAttribute(testingEClass, TESTING__NO);
		createEAttribute(testingEClass, TESTING__QUANTIFIER);
		createEReference(testingEClass, TESTING__ELEMENT);
		createEReference(testingEClass, TESTING__SATISFY);
		...
		createEAttribute(isInheritorEClass, IS_INHERITOR__MAX_LEVEL);
		...
		createEAttribute(isExtendedEClass, IS_EXTENDED__IS_EXTENDS);

		methodEClass = createEClass(METHOD);

		haveConstantEClass = createEClass(HAVE_CONSTANT);

		variableEClass = createEClass(VARIABLE);
		createEAttribute(variableEClass, VARIABLE__POSITION);
		createEAttribute(variableEClass, VARIABLE__INITIALIZE);
	...
	public void initializePackageContents() {
		...
		haveConstantEClass.getESuperTypes().add(this.getMethod());
		variableEClass.getESuperTypes().add(this.getMethod());
		...
		javaDocEClass.getESuperTypes().add(this.getPackage());
		...
		initEReference(getRule_On(), this.getTesting(), null, "on", null, 1, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(testingEClass, Testing.class, "Testing", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTesting_No(), ecorePackage.getEBoolean(), "no", "false", 1, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTesting_Quantifier(), this.getQuantifier(), "quantifier", null, 1, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTesting_Element(), this.getElement(), null, "element", null, 1, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTesting_Satisfy(), this.getOr(), null, "satisfy", null, 1, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getElement_Element(), this.getElementJava(), "element", null, 1, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getElement_Filter(), this.getOr(), null, "filter", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIsInheritor_MaxLevel(), ecorePackage.getEBigInteger(), "maxLevel", null, 0, 1, IsInheritor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(implementsEClass, Implements.class, "Implements", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getImplements_MaxInterface(), ecorePackage.getEBigInteger(), "maxInterface", null, 0, 1, Implements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(isExtendedEClass, IsExtended.class, "IsExtended", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIsExtended_IsExtends(), ecorePackage.getEBoolean(), "isExtends", "false", 1, 1, IsExtended.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodEClass, Method.class, "Method", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(haveConstantEClass, HaveConstant.class, "HaveConstant", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(variableEClass, Variable.class, "Variable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVariable_Position(), ecorePackage.getEBoolean(), "position", "false", 1, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariable_Initialize(), ecorePackage.getEBoolean(), "initialize", "false", 1, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConteins_Which(), this.getTesting(), null, "which", null, 1, 1, Conteins.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(actionEEnum, Action.CHECK);
		addEEnumLiteral(actionEEnum, Action.CORRECT);
