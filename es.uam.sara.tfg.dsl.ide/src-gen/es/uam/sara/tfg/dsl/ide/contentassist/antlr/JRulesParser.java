		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getImplementsAccess().getMinInterfaceAssignment_2_1(), "rule__Implements__MinInterfaceAssignment_2_1");
					put(grammarAccess.getImplementsAccess().getMaxInterfaceAssignment_3_2(), "rule__Implements__MaxInterfaceAssignment_3_2");
