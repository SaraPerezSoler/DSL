		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNameOperationAccess().getAlternatives(), "rule__NameOperation__Alternatives");
					put(grammarAccess.getNameOperationAccess().getAlternatives_0_1_0(), "rule__NameOperation__Alternatives_0_1_0");
					put(grammarAccess.getNameOperationAccess().getAlternatives_1_0(), "rule__NameOperation__Alternatives_1_0");
					put(grammarAccess.getNameTypeAccess().getAlternatives_2(), "rule__NameType__Alternatives_2");
					put(grammarAccess.getContainsAccess().getAlternatives(), "rule__Contains__Alternatives");
					put(grammarAccess.getContainsAccess().getAlternatives_0_1_0(), "rule__Contains__Alternatives_0_1_0");
					...
					put(grammarAccess.getIsImplementedAccess().getGroup_0_1(), "rule__IsImplemented__Group_0_1__0");
					put(grammarAccess.getIsImplementedAccess().getGroup_0_4(), "rule__IsImplemented__Group_0_4__0");
					put(grammarAccess.getIsSuperInterfaceAccess().getGroup(), "rule__IsSuperInterface__Group__0");
					put(grammarAccess.getIsSuperInterfaceAccess().getGroup_0_1(), "rule__IsSuperInterface__Group_0_1__0");
					put(grammarAccess.getIsSuperInterfaceAccess().getGroup_0_4(), "rule__IsSuperInterface__Group_0_4__0");
					put(grammarAccess.getIsSuperClassAccess().getGroup(), "rule__IsSuperClass__Group__0");
					put(grammarAccess.getIsSuperClassAccess().getGroup_0_1(), "rule__IsSuperClass__Group_0_1__0");
					put(grammarAccess.getIsSuperClassAccess().getGroup_0_4(), "rule__IsSuperClass__Group_0_4__0");
					put(grammarAccess.getIsSubClassAccess().getGroup(), "rule__IsSubClass__Group__0");
					put(grammarAccess.getIsSubClassAccess().getGroup_1_1(), "rule__IsSubClass__Group_1_1__0");
					put(grammarAccess.getIsSubClassAccess().getGroup_1_4(), "rule__IsSubClass__Group_1_4__0");
					put(grammarAccess.getIsSubClassAccess().getGroup_3(), "rule__IsSubClass__Group_3__0");
					...
					put(grammarAccess.getConstructorAccess().getGroup_1_1(), "rule__Constructor__Group_1_1__0");
					put(grammarAccess.getConstructorAccess().getGroup_1_4(), "rule__Constructor__Group_1_4__0");
					...
					put(grammarAccess.getInitializeAccess().getGroup_1_1(), "rule__Initialize__Group_1_1__0");
					put(grammarAccess.getInitializeAccess().getGroup_1_4(), "rule__Initialize__Group_1_4__0");
					put(grammarAccess.getEmptyAccess().getGroup(), "rule__Empty__Group__0");
					put(grammarAccess.getEmptyAccess().getGroup_1_1(), "rule__Empty__Group_1_1__0");
					put(grammarAccess.getEmptyAccess().getGroup_1_4(), "rule__Empty__Group_1_4__0");
					put(grammarAccess.getIsGenericAccess().getGroup(), "rule__IsGeneric__Group__0");
					put(grammarAccess.getIsGenericAccess().getGroup_1_1(), "rule__IsGeneric__Group_1_1__0");
					put(grammarAccess.getIsGenericAccess().getGroup_1_4(), "rule__IsGeneric__Group_1_4__0");
					put(grammarAccess.getNameOperationAccess().getGroup_0(), "rule__NameOperation__Group_0__0");
					put(grammarAccess.getNameOperationAccess().getGroup_0_1(), "rule__NameOperation__Group_0_1__0");
					put(grammarAccess.getNameOperationAccess().getGroup_0_1_0_0(), "rule__NameOperation__Group_0_1_0_0__0");
					put(grammarAccess.getNameOperationAccess().getGroup_1(), "rule__NameOperation__Group_1__0");
					put(grammarAccess.getNameOperationAccess().getGroup_1_2(), "rule__NameOperation__Group_1_2__0");
					...
					put(grammarAccess.getContainsAccess().getGroup_0(), "rule__Contains__Group_0__0");
					put(grammarAccess.getContainsAccess().getGroup_0_1(), "rule__Contains__Group_0_1__0");
					put(grammarAccess.getContainsAccess().getGroup_0_1_0_0(), "rule__Contains__Group_0_1_0_0__0");
					put(grammarAccess.getContainsAccess().getGroup_0_1_0_2(), "rule__Contains__Group_0_1_0_2__0");
					put(grammarAccess.getContainsAccess().getGroup_1(), "rule__Contains__Group_1__0");
					put(grammarAccess.getModifiersAccess().getGroup(), "rule__Modifiers__Group__0");
					put(grammarAccess.getModifiersAccess().getGroup_0_1(), "rule__Modifiers__Group_0_1__0");
					put(grammarAccess.getModifiersAccess().getGroup_0_4(), "rule__Modifiers__Group_0_4__0");
					...
					put(grammarAccess.getRuleSetAccess().getSentencesAssignment_4_1(), "rule__RuleSet__SentencesAssignment_4_1");
					...
					put(grammarAccess.getVariableAccess().getSatisfyAssignment_4(), "rule__Variable__SatisfyAssignment_4");
					...
					put(grammarAccess.getRuleAccess().getInAssignment_3_1(), "rule__Rule__InAssignment_3_1");
					put(grammarAccess.getRuleAccess().getFilterAssignment_4_1(), "rule__Rule__FilterAssignment_4_1");
					put(grammarAccess.getRuleAccess().getSatisfyAssignment_5_1(), "rule__Rule__SatisfyAssignment_5_1");
					...
					put(grammarAccess.getIsImplementedAccess().getNoAssignment_0_1_0(), "rule__IsImplemented__NoAssignment_0_1_0");
					put(grammarAccess.getIsImplementedAccess().getNoAssignment_0_2(), "rule__IsImplemented__NoAssignment_0_2");
					put(grammarAccess.getIsImplementedAccess().getNoAssignment_0_4_0(), "rule__IsImplemented__NoAssignment_0_4_0");
					put(grammarAccess.getIsImplementedAccess().getNoAssignment_0_5(), "rule__IsImplemented__NoAssignment_0_5");
					put(grammarAccess.getIsImplementedAccess().getValoresAssignment_2(), "rule__IsImplemented__ValoresAssignment_2");
					put(grammarAccess.getIsSuperInterfaceAccess().getNoAssignment_0_1_0(), "rule__IsSuperInterface__NoAssignment_0_1_0");
					put(grammarAccess.getIsSuperInterfaceAccess().getNoAssignment_0_2(), "rule__IsSuperInterface__NoAssignment_0_2");
					put(grammarAccess.getIsSuperInterfaceAccess().getNoAssignment_0_4_0(), "rule__IsSuperInterface__NoAssignment_0_4_0");
					put(grammarAccess.getIsSuperInterfaceAccess().getNoAssignment_0_5(), "rule__IsSuperInterface__NoAssignment_0_5");
					put(grammarAccess.getIsSuperInterfaceAccess().getValoresAssignment_2(), "rule__IsSuperInterface__ValoresAssignment_2");
					put(grammarAccess.getIsSuperClassAccess().getNoAssignment_0_1_0(), "rule__IsSuperClass__NoAssignment_0_1_0");
					put(grammarAccess.getIsSuperClassAccess().getNoAssignment_0_2(), "rule__IsSuperClass__NoAssignment_0_2");
					put(grammarAccess.getIsSuperClassAccess().getNoAssignment_0_4_0(), "rule__IsSuperClass__NoAssignment_0_4_0");
					put(grammarAccess.getIsSuperClassAccess().getNoAssignment_0_5(), "rule__IsSuperClass__NoAssignment_0_5");
					put(grammarAccess.getIsSuperClassAccess().getValoresAssignment_2(), "rule__IsSuperClass__ValoresAssignment_2");
					put(grammarAccess.getIsSubClassAccess().getNoAssignment_1_1_0(), "rule__IsSubClass__NoAssignment_1_1_0");
					put(grammarAccess.getIsSubClassAccess().getNoAssignment_1_2(), "rule__IsSubClass__NoAssignment_1_2");
					put(grammarAccess.getIsSubClassAccess().getNoAssignment_1_4_0(), "rule__IsSubClass__NoAssignment_1_4_0");
					put(grammarAccess.getIsSubClassAccess().getNoAssignment_1_5(), "rule__IsSubClass__NoAssignment_1_5");
					put(grammarAccess.getIsSubClassAccess().getOfAssignment_3_1(), "rule__IsSubClass__OfAssignment_3_1");
					...
					put(grammarAccess.getConstructorAccess().getNoAssignment_1_1_0(), "rule__Constructor__NoAssignment_1_1_0");
					put(grammarAccess.getConstructorAccess().getNoAssignment_1_2(), "rule__Constructor__NoAssignment_1_2");
					put(grammarAccess.getConstructorAccess().getNoAssignment_1_4_0(), "rule__Constructor__NoAssignment_1_4_0");
					put(grammarAccess.getConstructorAccess().getNoAssignment_1_5(), "rule__Constructor__NoAssignment_1_5");
					...
					put(grammarAccess.getInitializeAccess().getNoAssignment_1_1_0(), "rule__Initialize__NoAssignment_1_1_0");
					put(grammarAccess.getInitializeAccess().getNoAssignment_1_2(), "rule__Initialize__NoAssignment_1_2");
					put(grammarAccess.getInitializeAccess().getNoAssignment_1_4_0(), "rule__Initialize__NoAssignment_1_4_0");
					put(grammarAccess.getInitializeAccess().getNoAssignment_1_5(), "rule__Initialize__NoAssignment_1_5");
					put(grammarAccess.getEmptyAccess().getNoAssignment_1_1_0(), "rule__Empty__NoAssignment_1_1_0");
					put(grammarAccess.getEmptyAccess().getNoAssignment_1_2(), "rule__Empty__NoAssignment_1_2");
					put(grammarAccess.getEmptyAccess().getNoAssignment_1_4_0(), "rule__Empty__NoAssignment_1_4_0");
					put(grammarAccess.getEmptyAccess().getNoAssignment_1_5(), "rule__Empty__NoAssignment_1_5");
					put(grammarAccess.getIsGenericAccess().getNoAssignment_1_1_0(), "rule__IsGeneric__NoAssignment_1_1_0");
					put(grammarAccess.getIsGenericAccess().getNoAssignment_1_2(), "rule__IsGeneric__NoAssignment_1_2");
					put(grammarAccess.getIsGenericAccess().getNoAssignment_1_4_0(), "rule__IsGeneric__NoAssignment_1_4_0");
					put(grammarAccess.getIsGenericAccess().getNoAssignment_1_5(), "rule__IsGeneric__NoAssignment_1_5");
					put(grammarAccess.getNameOperationAccess().getNoAssignment_0_1_0_0_0(), "rule__NameOperation__NoAssignment_0_1_0_0_0");
					put(grammarAccess.getNameOperationAccess().getNoAssignment_0_1_0_1(), "rule__NameOperation__NoAssignment_0_1_0_1");
					put(grammarAccess.getNameOperationAccess().getOperatorAssignment_0_1_1(), "rule__NameOperation__OperatorAssignment_0_1_1");
					put(grammarAccess.getNameOperationAccess().getNoAssignment_1_0_1(), "rule__NameOperation__NoAssignment_1_0_1");
					put(grammarAccess.getNameOperationAccess().getNameAssignment_1_1(), "rule__NameOperation__NameAssignment_1_1");
					put(grammarAccess.getNameOperationAccess().getLanguageAssignment_1_2_1(), "rule__NameOperation__LanguageAssignment_1_2_1");
					...
					put(grammarAccess.getContainsAccess().getNoAssignment_0_1_0_0_0(), "rule__Contains__NoAssignment_0_1_0_0_0");
					put(grammarAccess.getContainsAccess().getNoAssignment_0_1_0_1(), "rule__Contains__NoAssignment_0_1_0_1");
					put(grammarAccess.getContainsAccess().getNoAssignment_0_1_0_2_0(), "rule__Contains__NoAssignment_0_1_0_2_0");
					put(grammarAccess.getContainsAccess().getNoAssignment_0_1_0_3(), "rule__Contains__NoAssignment_0_1_0_3");
					put(grammarAccess.getContainsAccess().getNoAssignment_1_0(), "rule__Contains__NoAssignment_1_0");
					put(grammarAccess.getContainsAccess().getWhichAssignment_1_1(), "rule__Contains__WhichAssignment_1_1");
					put(grammarAccess.getModifiersAccess().getNoAssignment_0_1_0(), "rule__Modifiers__NoAssignment_0_1_0");
					put(grammarAccess.getModifiersAccess().getNoAssignment_0_2(), "rule__Modifiers__NoAssignment_0_2");
					put(grammarAccess.getModifiersAccess().getNoAssignment_0_4_0(), "rule__Modifiers__NoAssignment_0_4_0");
					put(grammarAccess.getModifiersAccess().getNoAssignment_0_5(), "rule__Modifiers__NoAssignment_0_5");
					put(grammarAccess.getModifiersAccess().getBlendAssignment_4(), "rule__Modifiers__BlendAssignment_4");
					put(grammarAccess.getModifiersAccess().getBlendAssignment_5_1(), "rule__Modifiers__BlendAssignment_5_1");
