		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableAccess().getInAssignment_3_1(), "rule__Variable__InAssignment_3_1");
					put(grammarAccess.getVariableAccess().getFromAssignment_4_1(), "rule__Variable__FromAssignment_4_1");
					...
					put(grammarAccess.getRuleAccess().getFromAssignment_4_1(), "rule__Rule__FromAssignment_4_1");
