		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModifiersAccess().getAlternatives_2(), "rule__Modifiers__Alternatives_2");
					...
					put(grammarAccess.getAndAccess().getGroup_0_2(), "rule__And__Group_0_2__0");
					...
					put(grammarAccess.getImplementsAccess().getGroup_2_0_1(), "rule__Implements__Group_2_0_1__0");
					put(grammarAccess.getImplementsAccess().getGroup_2_1(), "rule__Implements__Group_2_1__0");
					put(grammarAccess.getImplementsAccess().getGroup_2_1_0(), "rule__Implements__Group_2_1_0__0");
					...
					put(grammarAccess.getModifiersAccess().getGroup_2_0(), "rule__Modifiers__Group_2_0__0");
					put(grammarAccess.getModifiersAccess().getGroup_2_0_3(), "rule__Modifiers__Group_2_0_3__0");
					put(grammarAccess.getModifiersAccess().getGroup_2_1(), "rule__Modifiers__Group_2_1__0");
					put(grammarAccess.getModifiersAccess().getGroup_2_1_1(), "rule__Modifiers__Group_2_1_1__0");
					...
					put(grammarAccess.getRuleSetAccess().getProjectNameAssignment_2_1(), "rule__RuleSet__ProjectNameAssignment_2_1");
					put(grammarAccess.getRuleSetAccess().getRulesAssignment_3(), "rule__RuleSet__RulesAssignment_3");
					put(grammarAccess.getRuleSetAccess().getRulesAssignment_5_0(), "rule__RuleSet__RulesAssignment_5_0");
					...
					put(grammarAccess.getAndAccess().getOpAssignment_0_1(), "rule__And__OpAssignment_0_1");
					put(grammarAccess.getAndAccess().getOpAssignment_0_2_1(), "rule__And__OpAssignment_0_2_1");
					put(grammarAccess.getAndAccess().getOpAssignment_1_0(), "rule__And__OpAssignment_1_0");
					put(grammarAccess.getAndAccess().getOpAssignment_1_1_1(), "rule__And__OpAssignment_1_1_1");
					put(grammarAccess.getImplementsAccess().getMinInterfaceAssignment_2_0_1_0(), "rule__Implements__MinInterfaceAssignment_2_0_1_0");
					put(grammarAccess.getImplementsAccess().getMaxInterfaceAssignment_2_0_1_2(), "rule__Implements__MaxInterfaceAssignment_2_0_1_2");
					put(grammarAccess.getImplementsAccess().getMinInterfaceAssignment_2_1_0_0(), "rule__Implements__MinInterfaceAssignment_2_1_0_0");
					...
					put(grammarAccess.getModifiersAccess().getBlendAssignment_2_0_1(), "rule__Modifiers__BlendAssignment_2_0_1");
					put(grammarAccess.getModifiersAccess().getBlendAssignment_2_0_3_2(), "rule__Modifiers__BlendAssignment_2_0_3_2");
					put(grammarAccess.getModifiersAccess().getBlendAssignment_2_1_0(), "rule__Modifiers__BlendAssignment_2_1_0");
					put(grammarAccess.getModifiersAccess().getBlendAssignment_2_1_1_1(), "rule__Modifiers__BlendAssignment_2_1_1_1");
