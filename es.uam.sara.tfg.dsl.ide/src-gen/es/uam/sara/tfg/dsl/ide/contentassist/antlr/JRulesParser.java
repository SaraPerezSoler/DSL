		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOrComplejoAccess().getOpAlternatives_0_0(), "rule__OrComplejo__OpAlternatives_0_0");
					put(grammarAccess.getOrComplejoAccess().getOpAlternatives_1_1_0(), "rule__OrComplejo__OpAlternatives_1_1_0");
					...
					put(grammarAccess.getOrComplejoAccess().getGroup(), "rule__OrComplejo__Group__0");
					put(grammarAccess.getOrComplejoAccess().getGroup_1(), "rule__OrComplejo__Group_1__0");
					put(grammarAccess.getAndSimpleAccess().getGroup(), "rule__AndSimple__Group__0");
					put(grammarAccess.getAndSimpleAccess().getGroup_1(), "rule__AndSimple__Group_1__0");
					put(grammarAccess.getAndComplejoAccess().getGroup(), "rule__AndComplejo__Group__0");
					put(grammarAccess.getAndComplejoAccess().getGroup_2(), "rule__AndComplejo__Group_2__0");
					...
					put(grammarAccess.getOrUnicoAccess().getOpAssignment(), "rule__OrUnico__OpAssignment");
					put(grammarAccess.getOrComplejoAccess().getOpAssignment_0(), "rule__OrComplejo__OpAssignment_0");
					put(grammarAccess.getOrComplejoAccess().getOpAssignment_1_1(), "rule__OrComplejo__OpAssignment_1_1");
					put(grammarAccess.getAndUnicoAccess().getOpAssignment(), "rule__AndUnico__OpAssignment");
					put(grammarAccess.getAndSimpleAccess().getOpAssignment_0(), "rule__AndSimple__OpAssignment_0");
					put(grammarAccess.getAndSimpleAccess().getOpAssignment_1_1(), "rule__AndSimple__OpAssignment_1_1");
					put(grammarAccess.getAndComplejoAccess().getOpAssignment_1(), "rule__AndComplejo__OpAssignment_1");
					put(grammarAccess.getAndComplejoAccess().getOpAssignment_2_1(), "rule__AndComplejo__OpAssignment_2_1");
