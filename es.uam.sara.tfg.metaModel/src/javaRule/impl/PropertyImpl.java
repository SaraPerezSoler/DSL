 ...
 * </p>
 * <ul>
 *   <li>{@link javaRule.impl.PropertyImpl#isNo <em>No</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	protected EClass eStaticClass() {
		return JavaRulePackage.Literals.PROPERTY;
	}
	...
	public void setNo(boolean newNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaRulePackage.PROPERTY__NO, oldNo, no));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaRulePackage.PROPERTY__NO:
				return isNo();
		}
