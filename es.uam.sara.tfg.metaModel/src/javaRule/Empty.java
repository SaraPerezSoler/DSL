 ...
 * </p>
 * <ul>
 *   <li>{@link javaRule.Empty#isNo <em>No</em>}</li>
 * </ul>
 *
 * @see javaRule.JavaRulePackage#getEmpty()
 * @model
 * @generated
 */
public interface Empty extends javaRule.Package, Method, javaRule.Class, Interface, Enumeration {
	 ...
	 * @see #setNo(boolean)
	 * @see javaRule.JavaRulePackage#getEmpty_No()
	 * @model default="false"
	 * @generated
	 */
	boolean isNo();
	...
	/**
	 * Sets the value of the '{@link javaRule.Empty#isNo <em>No</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
